 ...
 local _local_1_ = require("thyme.utils.fs") local file_readable_3f = _local_1_["file-readable?"] local fs = _local_1_
 ...
 return Path.join(self.root, module_name) end
 ...
 return fs.copyfile(path, self["module-name->backup-path"](self, module_name)) end
