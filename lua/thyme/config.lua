...
local default_opts = {["max-rollbacks"] = 10, preproc = nil, ["compiler-options"] = {}, ["fnl-dir"] = "fnl", ["macro-path"] = table.concat({"./fnl/?.fnlm", "./fnl/?/init.fnlm", "./fnl/?.fnl", "./fnl/?/init-macros.fnl", "./fnl/?/init.fnl"}, ";"), watch = {event = {"BufWritePost", "FileChangedShellPost"}, pattern = "*.fnlm?", notifier = vim.notify, strategy = "recompile"}}
local cache = {}
