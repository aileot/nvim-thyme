...
local _local_6_ = require("thyme.dependency.observer")
  ...
  if ("fennel" == module_name) then
    ...
    if not or_22_ then
      ...
      do
        local _24_
        do
          local _25_ = ModuleRollbackManager["inject-mounted-backup-searcher!"](ModuleRollbackManager, package.loaders)
          if (nil ~= _25_) then
            local searcher = _25_
