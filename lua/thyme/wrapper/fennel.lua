 ...
 local _local_1_ = require("thyme.wrapper.parinfer") local apply_parinfer = _local_1_["apply-parinfer"]
 local _local_2_ = require("thyme.utils.fs") local assert_is_fnl_file = _local_2_["assert-is-fnl-file"] local read_file = _local_2_["read-file"] local write_lua_file_21 = _local_2_["write-lua-file!"]


 local _local_3_ = require("thyme.config") local get_main_config = _local_3_["get-main-config"] local config_file_3f = _local_3_["config-file?"]
 ...
 local compiler_options = (_3fopts or config["compiler-options"]) local balanced_3f_fnl_code
 if vim.g.parinfer_loaded then
 balanced_3f_fnl_code = apply_parinfer(fnl_code) else
 balanced_3f_fnl_code = fnl_code end
 if (nil == compiler_options.filename) then compiler_options.filename = "fennel-in-thyme" else end



 return balanced_3f_fnl_code, compiler_options end
 ...
 return fennel.view(new_fnl_code, compiler_options) end
 ...
 local new_fnl_code, compiler_options = fnl_code__3efennel_ready(fnl_code, _3fopts)
 return fennel.eval(new_fnl_code, compiler_options) end
 ...
 return eval(("(eval-compiler " .. fnl_code .. ")"), _3fopts) end
 ...
 return eval(("(macrodebug " .. fnl_code .. ")"), _3fopts) end
 ...
 local new_fnl_code, compiler_options = fnl_code__3efennel_ready(fnl_code, _3fopts)
 return fennel["compile-string"](new_fnl_code, compiler_options) end
 ...
 return fennel0["compile-string"](fnl_lines, compiler_options) end
 ...
 return write_lua_file_21(lua_path, lua_lines) end
