 ...
 local _local_1_ = require("thyme.utils.fs") local file_readable_3f = _local_1_["file-readable?"] local write_log_file_21 = _local_1_["write-log-file!"] local append_log_file_21 = _local_1_["append-log-file!"]
 ...
 return Path.join(modmap_prefix, (log_id .. ".log")) end
 ...
 local logged_3f = file_readable_3f(log_path) local modmap
 if logged_3f then
 modmap = read_module_map_file(log_path) else
 modmap = {} end
 self["_log-path"] = log_path
 self["_entry-map"] = modmap[fnl_path]
 modmap[fnl_path] = nil
 self["_dep-map"] = modmap
 return self, logged_3f end
 ...
 local modmap_line = modmap__3eline(modmap) local log_path = self["get-log-path"](self)
 ...
 return self["_log-path"] end

 ModuleMap["get-entry-map"] = function(self)
 return self["_entry-map"] end

 ModuleMap["get-module-name"] = function(self)
 return self["_entry-map"]["module-name"] end

 ModuleMap["get-fnl-path"] = function(self)
 return self["_entry-map"]["fnl-path"] end

 ModuleMap["get-lua-path"] = function(self)
 return self["_entry-map"]["lua-path"] end

 ModuleMap["macro?"] = function(self)
 return self["_entry-map"]["macro?"] end

 ModuleMap["get-dependent-maps"] = function(self)
 return self["_dep-map"] end

 ModuleMap["get-dependent-map"] = function(self, dependent_fnl_path)
 return self["_dep-map"][dependent_fnl_path] end

 ModuleMap["add-dependent"] = function(self, dependent)
 if not self["_dep-map"][dependent["fnl-path"]] then
 local modmap_line = modmap__3eline(dependent) local log_path = self["get-log-path"](self)

 do end (self["_dep-map"])[dependent["fnl-path"]] = dependent
 return append_log_file_21(log_path, modmap_line) else return nil end end

 ModuleMap["clear!"] = function(self) local log_path = self["get-log-path"](self)
 ...
 self["_entry-map"] = nil
 self["_dep-map"] = nil
 return hide_file_21(log_path) end

 ModuleMap["restore!"] = function(self) local log_path = self["get-log-path"](self)


 self["_entry-map"] = self["__entry-map"]
 self["_dep-map"] = self["__dep-map"]
 return restore_file_21(log_path) end
