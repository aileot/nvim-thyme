...
(fn RollbackModuleHandler.module-name->backup-dir [self module-name]
...
(fn RollbackModuleHandler.module-name->backup-files [self module-name]
...
(fn RollbackModuleHandler.module-name->new-backup-path [self module-name]
...
(fn RollbackModuleHandler.module-name->active-backup-path [self module-name]
...
(fn RollbackModuleHandler.module-name->mounted-backup-path [self module-name]
...
(fn RollbackModuleHandler.should-update-backup? [self
                                                 module-name
                                                 expected-contents]
...
(fn RollbackModuleHandler.create-module-backup! [self module-name path]
...
(fn RollbackModuleHandler.search-module-from-mounted-backups [self module-name]
